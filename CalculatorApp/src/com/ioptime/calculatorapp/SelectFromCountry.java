...
public class SelectFromCountry extends SherlockActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Purchases.initiatePurchase(SelectFromCountry.this);
		...
		upgrade_text.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Purchases.makePurchase(SelectFromCountry.this);
//				if (checkvar == true) {
		...
		public View getView(final int position, View view, ViewGroup parent) {
			...
			view.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					String getCurrency = worldpopulationlist.get(position)
							.getCurrency();
					if (!currencyFullNames.contains(getCurrency)) {
						String stringItem = getCurrency;
						String split[] = stringItem.split("-");
						String CurrencyAbbreviation = split[0];
						CurrencyAbbreviation = CurrencyAbbreviation.trim();
						if (!fromCurrencyFlags.contains(String
								.valueOf(worldpopulationlist.get(position)
										.getFlag()))) {
							fromCurrencyNames = CurrencyAbbreviation;
							...
							Toast.makeText(getApplicationContext(),
									"Currency already added", Toast.LENGTH_LONG)
									.show();
						}
					}
						...
						Toast.makeText(getApplicationContext(),
								"Remove currency from conversion menu.",
