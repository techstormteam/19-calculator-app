...
public class SideNavigationView extends LinearLayout {
	private static final String LOG_TAG = SideNavigationView.class
			.getSimpleName();
	...
	int[] imgResc = { R.drawable.menu, R.drawable.menu1, R.drawable.menu2,
			R.drawable.menu3, R.drawable.menu4, R.drawable.menu5,
			R.drawable.menu6, R.drawable.menu7 };
	int[] imgRescClicked = { R.drawable.menu, R.drawable.menu1_p,
			R.drawable.menu2_p, R.drawable.menu3_p, R.drawable.menu4_p,
			R.drawable.menu5, R.drawable.menu6_p, R.drawable.menu7_p };
	private Mode mMode = Mode.LEFT;
	com.devspark.sidenavigation.SideNavigationView.SideNavigationAdapter.ViewHolder v;
	...
	private void initView() {
		...
		LayoutInflater.from(getContext())
				.inflate(sideNavigationRes, this, true);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (callback != null) {
					callback.onSideNavigationItemClick(menuItems.get(position)
							.getId());
				}
				// Log.d("position", v.image.getTag() + "");
	...
	/**
	 * Setup sliding mode of side menu ({@code Mode.LEFT} or {@code Mode.RIGHT}
	 * ). {@code Mode.LEFT} by default.
	 * 
	 * @param mode
	 *            Sliding mode
	 */
	...
	/**
	 * Getting current side menu mode ({@code Mode.LEFT} or {@code Mode.RIGHT}).
	 * {@code Mode.LEFT} by default.
	 * 
	...
	public void showMenu() {
		...
		navigationMenu.startAnimation(AnimationUtils.loadAnimation(
				getContext(), animRes));
	}
	...
	private class SideNavigationAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.side_navigation_item,
						null);
			...
			holder.image.setImageResource(imgResc[position]);
			holder.image.setTag(imgRescClicked[position]);
			...
			// holder.image.setOnTouchListener(l);
			...
			holder.image.setOnTouchListener(new OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					holder.image.setImageResource(imgRescClicked[position]);
					if (callback != null) {
						callback.onSideNavigationItemClick(menuItems.get(
								position).getId());
					}
					hideMenu();
					return true;
